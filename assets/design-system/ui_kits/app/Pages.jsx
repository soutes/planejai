...
const RendimentosPage = () => (
  <PlaceholderPage icon="💰" title="Rendimentos"
    blurb={<>Cadastre suas fontes de renda mensais. Use o módulo de Cartão para o detalhe de gastos, ou Despesas para fixas + variáveis.</>}/>
);
const DespesasPage = () => (
  <PlaceholderPage icon="📅" title="Despesas"
    blurb={<>As regras fixas que você cadastra em <b style={{color:'#E8ECF2'}}>⚙️ Configurações</b> aparecem aqui agrupadas por aba (Pessoal, Familiar, Educação…).</>}/>
);
const InvestPage = () => (
  <PlaceholderPage icon="📈" title="Investimentos"
    blurb={<>Cadastre saldos por categoria (Renda Fixa, Ações, FIIs, Cripto). O patrimônio aparece automaticamente na Visão Geral.</>}/>
);
const ConfigPage = () => (
  <PlaceholderPage icon="⚙️" title="Configurações"
    blurb={<>Abas de despesa, pessoas, regras fixas, categorias, cartões, ciclo de fatura. Tudo o que define o seu setup.</>}/>
);
